...
exports.createSale = async (req, res) => {
  try {
    ...
    const serviceObjects = await MyServiceModel.find({
      _id: { $in: services },
    ...
    const path = `/public/sale_invoice_${billNo}.pdf`;
...
exports.filterSales = async (req, res) => {
  try {
    ...
    const sales = await saleModel
      ...
      .populate(
        "customer",
        "customerName customerId mobileNumber whatsappNumber email address state modelName brandName"
      )
